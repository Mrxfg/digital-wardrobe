...
from app.schemas.auth import TelegramInitData, TelegramLogin, TokenResponse
...
def telegram_login(payload: TelegramLogin, db: Session = Depends(get_db)):
    """
    DEPRECATED: Use /auth/telegram-webapp instead.
    This endpoint accepts manual payload without signature verification.
    """
